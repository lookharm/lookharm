...
&nbsp;&nbsp;&nbsp;&nbsp;Mutex.Lock() และ Mutex.Unlock() การใช้งานที่เรียบง่าย แต่ลองดูซอร์สโค้ดใน sync/mutex ของ Go1.17 [1] ก็จะเห็นรายละเอียดที่ค่อนข้างมากประมาณ 135 บรรทัด [2] (ไม่รวมคอมเมนต์) บทความนี้มาลองทำความเข้าใจ Mutex ใน Go แต่หากจะเริ่มต้นที่ Go1.17 ในปี 2022 นี้ดูแล้วจะยากไป ขอย้อนเวลากลับไปเมื่อประมาณ 14 ปีที่แล้วก่อนที่ Go1 จะถูกปล่อยออกมา
