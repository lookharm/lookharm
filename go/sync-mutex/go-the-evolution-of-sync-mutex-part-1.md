...
&nbsp;&nbsp;&nbsp;&nbsp;Mutex หนึ่งในเครื่องมือหรือกลวิธีที่ทำให้โกรูทีน (goroutine) มีการทำงานที่สอดประสานกัน เช่น การอ่านและการเขียนค่าของตัวแปร เป็นต้น\
Mutex มีการใช้งานที่เรียบง่ายโดยเรียกใช้ฟังก์ชัน Lock และ Unlock แต่หากเราลองดูซอร์สโค้ดใน sync/mutex ของ Go1.17 [1] ก็จะเห็นรายละเอียดที่ค่อนข้างมากประมาณ 135 บรรทัด [2] (ไม่รวมคอมเมนต์) มีทั้งการแบ่งออกเป็น 2 โหมด stavation และ normal, การทำ spin, การทำ bit shift เพื่อใช้นับจำนวน watier ฯลฯ\
...
&nbsp;&nbsp;&nbsp;&nbsp;  เมื่อวันที่ 4 ธันวาคม ค.ศ. 2008 ก่อนที่ Go1 จะถูกปล่อยออกมา Russ Cox หนึ่งในผู้พัฒนาหลักของ Go ได้ทำการ commit [3] ด้วยข้อความที่แสนเรียบง่ายว่า `"add mutex.Mutex"` และนี่คือจุดเริ่มต้นของ Mutex หากลองดูซอร์สโค้ด [4] ก็จะพบว่าเป็นเวอร์ชั่นที่เรียบง่าย นับเป็นบรรทัดโดยประมาณ 32 บรรทัด (ไม่รวมคอมเมนต์) [5]
